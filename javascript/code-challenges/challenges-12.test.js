...
// First using ^ to start the string, then using \d to find number(0-9), then using {4} indicting the pin is 4 digit numbers
//$ is the end of the string
//test is to call on the expression and passing pin as parameter
/* ------------------------------------------------------------------------------------------------
CHALLENGE 3
...
// starting the string with ^ then finding upper or lower case letters with [a-zA-Z]
...
// using + to indicate the proceeding pattern must be the condition asked
/* ------------------------------------------------------------------------------------------------
CHALLENGE 5
...
const validateEmail = (email) => {
  const emailCheck = /^\w+(.\w+)@\w+(.com|.net|.org)$/i;
  return emailCheck.test(email);
};
// \w+ it will match first one or more word that has letters or digits or underscore
//(.\w+) matches a dot followed by one or more word characters
//then matches @
// \w+ matches one or more word characters
// match .come stuff
// $ to end the string and i is a flag to make it case insensitive
/* ------------------------------------------------------------------------------------------------
CHALLENGE 6
...
const validatePhoneNumber = (phoneNumber) => {
  ...
  const checkNumber = phone.test (phoneNumber);
  return checkNumber;
};

// first matching 3 digits or 3 digits in parentheses
//then match space [ -]? then match 3 digits then matches space
//finally matching 4 digits
/* ------------------------------------------------------------------------------------------------
