...
const maxInArray = (arr) => {
  return arr.reduce((previous, initial)=> Math.max(previous,initial));
};
// Reduce method here compare each element in the array with the previous found maximum value.
// Max math return the largest number of the given numbers
/* ------------------------------------------------------------------------------------------------
CHALLENGE 2
...
//returning an array of the object property
...
// returning an array that has the object property values
/* ------------------------------------------------------------------------------------------------
CHALLENGE 4
...
const updateNumbers = (obj) => {
  return Object.entries(obj).map(a => a.join (': '));
};


// Two Js functions
//object.entries will return an array that has key value pairs.
// map is called later on the array returned by object.entries
// a is basically a key value pair array that was obtained from object.entries(obj)
//: delimiter
//map here will return string in key:value format
...
//value.house represent the house property of the current object which is value.
/*------------------------------------------------------------------------------------------------
CHALLENGE 6
...
// check if the name is equal to the input character
/* ------------------------------------------------------------------------------------------------
