...
const updateAnimal = (arr, callback) => {
  let data = arr.map(value => callback (value));
  return data;
};
...
const sortNumbers = (arr) => {
  return arr.sort ((a, b) => a - b);  // sort the number ascending
};
...
const sortBackwards = (arr) => {
  return arr.sort ((a, b)=> b - a);  ///sort the number descending
};
...
const alphabetize = (arr) => {
  return arr.sort (); // the sort by default sort the elements in ascending order
};
