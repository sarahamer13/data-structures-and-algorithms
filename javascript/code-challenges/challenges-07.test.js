...
// Slice here is extracting substring starting from current index to end of the string then push the substring into the new array
// <= less than or equal. Meaning the loop will run until i is equal to the length of the string which is str
...
// using spread operator, convert into individual element
...
// split takes ' ' as argument then we use slice to remove first 2 words from an array then use join to concatenate the remaining words into a string.
